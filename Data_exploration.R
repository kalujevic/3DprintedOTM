...
## plotting the relationship between lizard temperature and each of the models
...
ggsave("Sceloporus_occidentalis_validation.pdf", height = 6, width = 8)


#plotting the variance around each model and lizard

plot2 <- ggplot(data=Extracted_data,aes(x=OTM_type,y=SD)) + 
